...
const About = () => {
  ...
  return (
    <Slider {...settings} >
      <Grid container sx={{ display: 'flex !important', 'backgroundColor': '#F2F0FF', "marginTop": "36px" }}>
        <Grid item md={6} xs={12} sx={{ display: 'flex', textAlign: "center", 'alignItems': 'center' }} >
          <Box dipslay="flex" alignItems="center" >
            ...
            <Typography component="div" sx={{ 'fontFamily': 'var(--josefin)', "fontSize": { xs: "28px", md: "40px" }, 'fontWeight': 'bold', 'lineHeight': '70px', 'letterSpacing': '1.5' }}>
              Feedback System for Government Departments
            </Typography>
            <Typography my={3} component="div" variant="p" sx={{ 'color': '#8A8FB9', 'fontFamily': 'Lato', 'fontStyle': 'normal', 'fontWeight': '600', 'fontSize': '16px', 'lineHeight': '28px' }}>
